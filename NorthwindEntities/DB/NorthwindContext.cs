namespace NorthwindEntities.DB
{
	...
	public partial class NorthwindContext : DbContext, IDbContext
	{
        ...
        public IQueryable<T> EntitySet<T>(string include) where T : class
        {
        ...
        public void Update<T>(T entityObject, params string[] properties) where T : EntityBase
        {
            throw new NotImplementedException();
        }

        public void UpdateExcept<T>(T entityObject, params string[] properties) where T : EntityBase
        {
            throw new NotImplementedException();
        }
    }
